...
datapath <- "/work/gene8940/tc88074/homework_5/kallisto"  # you need to modify this line to match the path made by your BASH script
resultdir <- "/work/gene8940/tc88074/homework_5"   # you need to modify this line to match the path made by your BASH script
setwd(resultdir)
